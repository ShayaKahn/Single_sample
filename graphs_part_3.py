...
Tongue_cohort = g3.find_most_abundant_rows(random_subjects, num)
real_sample = Tongue_cohort[:, 25]
temp_sample = Tongue_cohort[:, 24]
shuffled_sample = g3.create_shuffled(temp_sample, Tongue_cohort)
...
shuffled_sample = g3.create_shuffled(random_sample, Data_temp)
...
[new_overlap_vector_real, new_dissimilarity_vector_real] = g3.idoa(real_sample, Data,
                                                                   overlap_vector_real, dissimilarity_vector_real)
[new_overlap_vector_shuffled, new_dissimilarity_vector_shuffled] = g3.idoa(shuffled_sample, Data,
...
random_samples = g3.create_randomized_cohort(reference_cohort, temp_samples)

euclidean_dist_vector_real = g3.average_get_ed_vector(samples.T, reference_cohort.T)
euclidean_dist_vector_rand = g3.average_get_ed_vector(random_samples.T, reference_cohort.T)
...
shuffled_data = g3.create_randomized_cohort(temp_shuffled_data.T, ref_cohort.T)#, temp_shuffled_data.T)
...
ed_vector_shuffled_data = g3.average_get_ed_vector(shuffled_data, data)
ed_vector_real_data = g3.average_get_ed_vector(real_data, data)
